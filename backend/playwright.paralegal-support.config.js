...
const storageStatePath = path.join(__dirname, "tests/playwright/.auth/support-paralegal.json");
...
module.exports = defineConfig({
  testDir: path.join(__dirname, "tests/playwright/paralegal-support"),
  globalSetup: path.join(__dirname, "tests/playwright/paralegal-support/global.setup.js"),
  fullyParallel: false,
  workers: 1,
  ...
  reporter: [["list"]],
  outputDir: path.join(__dirname, "test-results/playwright-paralegal-support"),
  use: {
    baseURL,
    headless: true,
