...
function buildSupportConversationSystemPrompt({ userRole = "", caseId = "" } = {}) {
  ...
  return [
    ...
    "- Treat users as busy professionals. Infer reasonable LPC context from their role, page, conversation history, and wording.",
    "- For complex or multi-issue questions, organize the answer by issue instead of giving one generic response.",
    "- Give direct answers first, then practical next steps.",
